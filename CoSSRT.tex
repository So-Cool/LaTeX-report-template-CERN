...
\fancyhead[LE,LO]{\fontsize{9}{3}\selectfont\color{headerc}\textbf{CERN openlab Summer Student Report}}
\fancyhead[RE,RO]{\fontsize{9}{3}\selectfont\color{headerc}\textbf{\the\year}}
...
\titleformat*{\subsection}{\fontsize{13}{16}\bfseries\sffamily}
\titleformat*{\subsubsection}{\fontsize{11}{14}\bfseries\sffamily}
...
\footrulecolor{linec}
\fancyfoot[LE,LO]{ \fontsize{9}{3}\selectfont \textcolor{footerc}{\textbf{\thepage~$|$}}~\textcolor{footerc1}{\texttt{Page}}} % \fontfamily{ppl}\selectfont
